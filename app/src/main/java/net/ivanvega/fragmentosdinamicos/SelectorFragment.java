        ...
        miAdaptadorPersonalizado.setOnClickLister(view ->
            {
                ...
                ((MainActivity)this.contexto).mostrarDetalle((int) miAdaptadorPersonalizado.getItemId(
                        recyclerViewLibros.getChildAdapterPosition(view)
                ));
            }
        );
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    switch (i){
                                        ...
                                        case 1:
                                            ...
                                            miAdaptadorPersonalizado.insertar((Libro) miAdaptadorPersonalizado.getItem(posLibro));
                                            miAdaptadorPersonalizado
                                                    .notifyItemInserted(
